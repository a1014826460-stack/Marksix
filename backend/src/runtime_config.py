...
CONFIG_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "prediction.simulation.target_hit_rate": {
        "value": 0.5,
        "value_type": "float",
        "description": "Taiwan future-draw simulation target hit rate for batch generation.",
        "is_secret": 0,
    },
    "prediction.simulation.max_consecutive_hits": {
        "value": 3,
        "value_type": "int",
        "description": "Maximum consecutive simulated hits before forcing a miss.",
        "is_secret": 0,
    },
    "prediction.simulation.max_consecutive_misses": {
        "value": 3,
        "value_type": "int",
        "description": "Maximum consecutive simulated misses before forcing a hit.",
        "is_secret": 0,
    },
