...
if (config.bridge.runtime.draw_selector !== ".KJ-TabBox" || config.bridge.runtime.legacy_prediction_scripts !== "enabled" || config.brand.footer.imageUrls.length !== 4) throw new Error("bridge config must project existing DOM runtime selectors and footer images")
