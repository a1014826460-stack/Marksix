...
function renderFormulaMissing() {
  return `
    <table border="1" width="100%" bgcolor="#ffffff">
      <tbody>
        <tr>
          <td style="border:10px double #00f; height: 50px;" bgcolor="#0000FF"><p align="center"><b><font color="#FFFF00" face="楷体" style="font-size: 20pt">金牛论坛【公式平特肖】</font></b></p></td>
        </tr>
      </tbody>
    </table>
      ...
      <tbody>
        <tr style="height: 26.125px;">
          <td style="width: 99.9915%; background-color: #0c35f5; height: 26.125px; text-align: center;" colspan="2">
            <span style="font-size: 14pt; font-family: 'Helvetica Neue', Helvetica, Arial, 'Microsoft Yahei', 'Hiragino Sans GB', 'Heiti SC', 'WenQuanYi Micro Hei', sans-serif;"><strong><span style="color: #ffffff;">金牛论坛一肖一码大公开</span></strong></span>
          </td>
        </tr>
        <tr>
          ...
          <tr>
            <td style="text-align:center" height="60">
              <table border="1" width="100%" bgcolor="#ffffff">
                <tbody>
                  <tr>
                    <td style="border:10px double #00f" bgcolor="#0000FF" height="50"><p align="center"><b><font face="楷体" style="font-size: 20pt"><font color="#FFFF00">金牛论坛</font><font color="#FFFFFF">『四肖八码』</font></font></b></p></td>
                  </tr>
                </tbody>
              </table>
            </td>
...
function renderSanxiaoSiwei(xiaoRows: LegacyModeRow[], weiRows: LegacyModeRow[]) {
  ...
  if (!mergedRows.length) {
    return renderMissingTable('<font color="#FFFF00">金牛论坛</font><font color="#FFFFFF">『三肖四尾』</font>')
  }
        ...
        <tr>
          <td style="text-align:center" height="60">
            <table border="1" width="100%" bgcolor="#ffffff">
              <tbody>
                <tr>
                  <td style="border:10px double #00f; height: 50px;" bgcolor="#0000FF"><p align="center"><b><font color="#FFFF00" face="楷体" style="font-size: 18pt">金牛论坛</font><font color="#FFFFFF" face="楷体" style="font-size: 18pt">『三肖四尾』</font></b></p></td>
                </tr>
              </tbody>
            </table>
            ${body}
...
function renderDanshuangSixiaoBama(rows: LegacyModeRow[]) {
  if (!rows.length) {
    return renderMissingTable('<font color="#FFFF00">金牛论坛</font><font color="#FFFFFF">『单双四肖八码』</font>')
  }
  ...
  const body = rows
    .map((row) => {
      ...
      const renderGroup = (label: string, values: string[], hit: boolean) =>
        `【${label}】${values
          .map((value) =>
            hit && value === result.zodiac
              ? `<span style="background-color: #FFFF00">${escapeHtml(value)}</span>`
              : escapeHtml(value)
          )
          .join("")}`
      ...
      return `
        <tr>
          <td style="color:#000;font-family:微软雅黑;font-weight:700;border:1px solid #000" align="center" width="100%" height="50">
            <font style="font-weight:700" size="3" face="微软雅黑">
              <span style="color: #00F;">${escapeHtml(row.term)}期：</span><span style="color: #000;">单双四肖八码</span>
              开:<span style="color: #F00; background-color: #FFFF00;">${renderResultPlain(result, "?????")}${result.isOpened ? hitA || hitB ? '<font color="#FF0000">对</font>' : '<font color="#000000">错</font>' : ""}</span>
            </font></td>
        </tr>
        <tr>
          <td style="color:#000;font-family:微软雅黑;font-weight:700;border:1px solid #000" align="center" width="100%" height="50">
            <p style="line-height:200%"><span style="font-size:13pt;font-family:微软雅黑;color: #000">${renderGroup("四肖A", groupA, hitA)}<br>${renderGroup("四肖B", groupB, hitB)}</span></p>
          </td>
        </tr>
      `
    })
        ...
        <tr>
          <td style="text-align:center" height="60">
            <table border="1" width="100%" bgcolor="#ffffff">
              <tbody>
                <tr>
                  <td style="border:10px double #00f" bgcolor="#0000FF" height="50"><p align="center"><b><font face="楷体" style="font-size: 20pt"><font color="#FFFF00">金牛论坛</font><font color="#FFFFFF">『单双四肖八码』</font></font></b></p></td>
                </tr>
              </tbody>
            </table>
          </td>
...
function renderPingteXiao(rows: LegacyModeRow[]) {
  if (!rows.length) {
    return renderMissingTable('<font color="#FFFF00">99988111.com</font><font color="#FFFFFF">『平特一肖』</font>')
  }
        ...
        <tr>
          <td style="text-align:center" height="60">
            <table border="1" width="100%" bgcolor="#ffffff">
              <tbody>
                <tr>
                  <td style="border:10px double #00f; height: 50px;" bgcolor="#0000FF"><p align="center"><b><font color="#FFFF00" face="楷体" style="font-size: 20pt">99988111.com</font><font color="#FFFFFF" face="楷体" style="font-size: 20pt">『平特一肖』</font></b></p></td>
                </tr>
              </tbody>
            </table>
          </td>
...
function renderPingteWei(rows: LegacyModeRow[]) {
  if (!rows.length) {
    return renderMissingTable('<font color="#FFFF00">99988111.com</font><font color="#FFFFFF">『平特一尾』</font>')
  }
        ...
        <tr>
          <td style="text-align:center" height="60">
            <table border="1" width="100%" bgcolor="#ffffff">
              <tbody>
                <tr>
                  <td style="border:10px double #00f; height: 50px;" bgcolor="#0000FF"><p align="center"><b><font color="#FFFF00" face="楷体" style="font-size: 20pt">99988111.com</font><font color="#FFFFFF" face="楷体" style="font-size: 20pt">『平特一尾』</font></b></p></td>
                </tr>
              </tbody>
            </table>
          </td>
...
function renderHeShuDaxiao(rows: LegacyModeRow[]) {
  ...
  const body = rows
    .map((row) => {
      ...
      const isCorrect = result.isOpened && Boolean(label) && label === hitLabel
      const display = isCorrect ? `<span style="background-color: #FFFF00">${escapeHtml(label)}</span>` : escapeHtml(label)
      return `
        <table style="border-collapse:collapse" border="1" width="100%" bgcolor="#ffffff" height="41">
          <tbody>
            <tr>
              <td width="100%" height="41"><p align="center"><font face="楷体"><b><font size="4"><font color="#008000">${escapeHtml(row.term)}期</font>【<font color="#FF0000">${display}</font>】开<font color="#FF00FF">(${renderResultJudge(result, isCorrect, "?????")})</font></font></b></font></p></td>
            </tr>
          </tbody>
        </table>
      `
  ...
  if (!rows.length) {
    return `
      <table border="1" width="100%" bgcolor="#ffffff">
        <tbody>
          <tr>
            <td style="border:10px double #00f; height: 50px;" bgcolor="#0000FF"><p align="center"><b><font color="#FFFF00" face="楷体" style="font-size: 20pt">99988111.com</font><font color="#FFFFFF" face="楷体" style="font-size: 20pt">【八肖十六码】</font></b></p></td>
          </tr>
        </tbody>
      </table>
    ...
    .map((row) => {
      ...
      return `
        <table style="border-collapse: collapse; width: 99.9412%;" border="1">
          <tbody>
            <tr style="height: 26.125px;">
              <td style="width: 99.9915%; background-color: #0c35f5; height: 26.125px; text-align: center;" colspan="2"><span style="font-size: 14pt; font-family: 'Helvetica Neue', Helvetica, Arial, 'Microsoft Yahei', 'Hiragino Sans GB', 'Heiti SC', 'WenQuanYi Micro Hei', sans-serif;"><strong><span style="color: #ffffff;">${escapeHtml(row.term)}期金牛论坛一肖一码大公开</span></strong></span></td>
            </tr>
            ...
            <tr style="height: 50.9583px;">
              <td style="height: 50.9583px; width: 99.9915%; text-align: center;" colspan="2"><p><span style="font-family: 'Helvetica Neue', Helvetica, Arial, 'Microsoft Yahei', 'Hiragino Sans GB', 'Heiti SC', 'WenQuanYi Micro Hei', sans-serif; font-size: 12pt;"><strong><span style="color: #0000ff;">${escapeHtml(row.term)}期</span><span style="color: #ff0000;">一肖一码</span><span style="color: #000000;">开奖【99988111.com】${row.isCorrect ? "中奖" : row.result.isOpened ? "未中" : ""}</span></strong></span></p></td>
            </tr>
          </tbody>
        </table>
      `
...
export async function getTwjinniuHomepageModules(
  ...
  const mode83Rows = await loadLegacyModeRows(83, lotteryType, 20)
  ...
  const modules: Record<HomepageModuleKey, TwjinniuHomepageModulePayload> = {
    ...
    qianhou_24ma: {
      key: "qianhou_24ma",
      title: "前后24码",
      status: mode110Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">金牛论坛</font><font color="#FFFFFF">推荐『前后24码』的好料</font>'),
      mappedModeIds: [110],
      notes: mode110Rows.length
        ? ["已确认该模块对应 modes_id 110，但当前返回字段不足以在不猜测的前提下还原原站『前后落码→24码中特』结构。"]
        : ["已按 modes_id 110 查询，本地 PostgreSQL 当前彩种没有历史行。"],
    },
    sanxiao_15ma: {
      key: "sanxiao_15ma",
      title: "三肖15码中特",
      status: mode72Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">金牛论坛</font><font color="#FFFFFF">推荐『三肖15码中特』的好料</font>'),
      mappedModeIds: [72],
      notes: mode72Rows.length
        ? ["已确认该模块对应 modes_id 72，但当前返回字段不足以在不猜测的前提下还原原站『7/5/3肖特 + 15码』组合布局。"]
        : ["已按 modes_id 72 查询，本地 PostgreSQL 当前彩种没有历史行。"],
    },
    shisi_mazhong: {
      key: "shisi_mazhong",
      title: "14码中特",
      status: mode77Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">本站出品</font><font color="#FFFFFF">【14码中特】</font>'),
      mappedModeIds: [77],
      notes: mode77Rows.length
        ? ["已确认该模块对应 modes_id 77，但当前返回字段不足以在不猜测的前提下还原原站 14 个号码的排版结构。"]
        : ["已按 modes_id 77 查询，本地 PostgreSQL 当前彩种没有历史行。"],
    },
    sixiao_bama: {
      key: "sixiao_bama",
      title: "四肖八码",
      status: mode83Rows.some((row) => parseLabelCodeEntries(row.content).length >= 4) ? "ok" : "missing_data",
    ...
    danshuang_sixiao_bama: {
      ...
      title: "单双四肖八码",
      status: mode31Rows.length ? "ok" : "missing_data",
    ...
    sixiao_sima: {
      key: "sixiao_sima",
      title: "四肖四码",
      status: mode78Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">今日推荐</font><font color="#FFFFFF">『四肖四码』</font>'),
      mappedModeIds: [78],
      notes: mode78Rows.length
        ? ["已确认该模块对应 modes_id 78，但当前返回字段不足以在不猜测的前提下还原原站『四肖四码』逐期结构。"]
    ...
    yixiao_sanma: {
      key: "yixiao_sanma",
      title: "一肖三码",
      status: mode484Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">金牛论坛</font><font color="#FFFFFF">推荐一肖三码</font>'),
      mappedModeIds: [484],
      notes: mode484Rows.length
        ? ["已确认该模块对应 modes_id 484，但当前返回字段不足以在不猜测的前提下还原原站『18码/9码/1肖/3肖/6肖』组合布局。"]
        : ["已按 modes_id 484 查询，本地 PostgreSQL 当前彩种没有历史行。"],
    },
    jixian_texiao: {
      key: "jixian_texiao",
      title: "极限特肖",
      status: mode43Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">99988111.com</font><font color="#FFFFFF">【极限特肖】</font>'),
      mappedModeIds: [43],
      notes: mode43Rows.length
        ? ["已确认该模块对应 modes_id 43，但当前返回字段不足以在不猜测的前提下还原原站『六期计划理财两肖』布局。"]
    ...
    qianhou_texiao: {
      key: "qianhou_texiao",
      title: "前后特肖",
      status: mode219Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">金牛论坛</font><font color="#FFFFFF">【前后特肖】</font>'),
      mappedModeIds: [219],
      notes: mode219Rows.length
        ? ["已确认该模块对应 modes_id 219，但当前返回字段缺少原站『前/后 + 两肖』所需内容列，不能无猜测复原。"]
        : ["已按 modes_id 219 查询，本地 PostgreSQL 当前彩种没有历史行。"],
    },
    wenzhuan_baxiao: {
      key: "wenzhuan_baxiao",
      title: "稳赚八肖",
      status: mode180Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFFFF">多人来料【稳赚八肖】</font>'),
      mappedModeIds: [180],
      notes: mode180Rows.length
        ? ["已确认该模块对应 modes_id 180，但当前返回字段不足以在不猜测的前提下还原原站『家野四肖/单双五肖/凶吉四肖/天地四肖/无错八肖』组合布局。"]
        : ["已按 modes_id 180 查询，本地 PostgreSQL 当前彩种没有历史行。"],
    },
    shiwu_mazhong: {
      key: "shiwu_mazhong",
      title: "15码中特",
      status: mode81Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">弑神者</font><font color="#FFFFFF">（99988111.com）15码中特</font>'),
      mappedModeIds: [81],
      notes: mode81Rows.length
        ? ["已确认该模块对应 modes_id 81，但当前返回字段不足以在不猜测的前提下还原原站『三尾/五尾/15码/9码/一尾一码』组合布局。"]
        : ["已按 modes_id 81 查询，本地 PostgreSQL 当前彩种没有历史行。"],
    },
    daxiao_yitou: {
      key: "daxiao_yitou",
      title: "大小一头",
      status: mode108Rows.length ? "missing_mapping" : "missing_data",
      html: renderMissingTable('<font color="#FFFF00">特码来迟</font><font color="#FFFFFF">『大小一头』</font>'),
      mappedModeIds: [108],
      notes: mode108Rows.length
        ? ["已确认该模块对应 modes_id 108，但当前返回字段不足以在不猜测的前提下还原原站『大小 + 头数』组合布局。"]
    ...
    yijuhua_zhongtema: {
      ...
      title: "一句话中特码",
      status: "missing_data",
      html: renderMissingTable('<font color="#FFFF00">99988111.com</font><font color="#FFFFFF">『一句话中特码』</font>'),
      mappedModeIds: [50],
      notes: mode50Rows.length
        ? ["已确认该模块对应 modes_id 50，但当前返回数据还不足以按原站样式渲染。"]
