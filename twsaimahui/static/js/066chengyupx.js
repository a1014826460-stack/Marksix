...
${d.term}期</strong><span class='styleliao'><strong>成语平特肖</strong></span>:【<span class='stylezi'><strong>${c1[0]}</strong></span><strong>】 开:${sxSplit[index]||'？'}${codeSplit[index]||'00'}${ (sx?( zj?'准':'错'):'??')}
</strong>
</td>
</tr>
            `
